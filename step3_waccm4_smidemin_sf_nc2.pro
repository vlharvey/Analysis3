...
; Input data:  IDL>restore,'/atmos/harvey/WACCM_data/Datfiles/Datfiles_Ethan_600yr/CO2x1SmidEmin_yBWCN/3d_CO2x1SmidEmin_yBWCN_YYYMMDD.nc
; dimensions:
...
ifiles=file_search(dirw+'3d_CO2x1SmidEmin_yBWCN_???????.nc',count=nfile)
;
; loop over files
;
...
;
    ofile=dirw+'3d_CO2x1SmidEmin_yBWCN_'+sdate+'.nc2'
