;
; read WACCM4 CO2x1SmidEmax_yBWCN set1 (and then set2) data and save daily files of 3d T, U, V, Z, CO
...
dir='/atmos/harvey/WACCM_data/Datfiles/Datfiles_Ethan_600yr/CO2x1SmidEmax_yBWCN/'
...
;
    for ii=0L,nvars-1L do restore,idir+ivars(ii)+'3d_CO2x1SmidEmax_yBWCN_'+syear+'_vE.sav'
...
;
    ...
    for iday=0L,nday-1L do begin
        ...
        print,'saved '+dir+'3d_CO2x1SmidEmax_yBWCN_'+sdates(iday)+'_vE.sav'
        save,file=dir+'3d_CO2x1SmidEmax_yBWCN_'+sdates(iday)+'_vE.sav',lon,lat,lev,cogrd,tgrd,ugrd,vgrd,zgrd
