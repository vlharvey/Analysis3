...
endfor		; loop over first 150 years
;
; second 150 years
;
...
;erase
;!type=2^2+2^3
;plot,u(80,36,*),ytitle='Ubar at 60N and 10hPa',yrange=[-50,100],color=0,charsize=2,title='FR-WACCM CO2x1SmidEmax_yBWCN_vE set2'
;oplot,u(80,36,*),thick=3,color=col1(iyr-152)
