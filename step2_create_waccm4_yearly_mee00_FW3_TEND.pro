...
spawn,'ls '+dirh+'*0101_TEND.sav',ifiles
...
; read WACCM data
;
      dum=findfile(dirh+'Year'+model_years(iyear)+'_'+sdate+'_TEND.sav')
...
;
      ...
      PTTEND00FPL_avg(*,*,icount)=PTTEND00FPL
      TTEND00FPL_avg(*,*,icount)=TTEND00FPL
;
jumpday:
      icount=icount+1L
goto,jump
...
;
saveit:
ofile=dirh+'Year'+model_years(iyear)+'_VLH_TEND.sav'
save,file=ofile,sdate_all,lat,lev,PTTEND00FPL_avg,TTEND00FPL_avg
