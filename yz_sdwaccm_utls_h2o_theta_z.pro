;
; plot yz SDWACCM h1 h2o, theta, z as a function of p
;
loadct,39
mcolor=255
device,decompose=0
...
spawn,'ls '+dir+'sdwaccm2012-2014_1_2_2.cam.h1.2013-07*-00000.nc',ifiles
...
h2o2da=1.e6*mean(h2o3da,dim=1)	;100.*(mean(h2o3da,dim=1)-h2o2d)/h2o2d		; % difference in mean water in asian sector over zonal mean
o32da=1.e6*mean(o33da,dim=1)		;100.*(mean(o33da,dim=1)-o32d)/o32d		; % difference in mean ozone in asian sector over zonal mean
...
contour,th2d,lat,lev,/overplot,level=[340,350,360,370,380,400],color=100,thick=3,/follow,/ylog
contour,t2d,lat,lev,/overplot,level=150+10*findgen(21),color=200,thick=3,/follow,/ylog
