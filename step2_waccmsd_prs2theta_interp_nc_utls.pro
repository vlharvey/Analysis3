...
; restore,'/Volumes/cloud/data/WACCM_data/Datfiles_SD/f_1975-2010_2deg_refc1sd_wa4_tsmlt.002.cam.h5.20120701.sav
; LAT             DOUBLE    = Array[96]
; LEV             DOUBLE    = Array[88]
...
thlev=[400.,390.,380.,370.,360.,350.,340.,330.,320.,310.,300.]
nth=n_elements(thlev)
PI2=6.2831853071796
DTR=PI2/360.
RADEA=6.37E6
dirw='/Volumes/cloud/data/WACCM_data/Datfiles_SD/'
ifiles=file_search(dirw+'f_1975-2010_2deg_refc1sd_wa4_tsmlt.002.cam.h5.201*.sav',count=nfile)
;
; loop over files
;
...
;
    result=file_search(dirw+'f_1975-2010_2deg_refc1sd_wa4_tsmlt.002.cam.h5.'+sdate+'_utls.nc')
...
;
ofile=dirw+'f_1975-2010_2deg_refc1sd_wa4_tsmlt.002.cam.h5.'+sdate+'_utls.nc'
print,'writing ',ofile
