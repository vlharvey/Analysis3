...
ifiles=dir+['noaurfpl_FW3NoSpin_paper1_Press_QNO.sav']
...
;
    ...
    QNONAFPL=reform(QNONAFPL_all(*,*,ifile))
    ofile=dir+'noaurfpl_FW3.cam2.h3.Year'+syear(ifile)+'_'+smon(ifile)+sday(ifile)+'_QNO.sav'
    print,ofile
    save,file=ofile,LAT,LEV,DATENAFPL,QNONAFPL
