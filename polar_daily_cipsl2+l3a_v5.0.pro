;
; read CIPS level 2a and 3a version 5.00 data and oplot geolocation information
;
loadct,39
mcolor=!p.color
...
pth='/aura7/harvey/CIPS_data/Datfiles/Level_2/cips_sci_2_orbit_'
...
;
      spawn,'ls '+pth+'*'+syear+'-'+sday+'*v05.10_r01_cat.nc',fnamescat
      spawn,'ls '+pth+'*'+syear+'-'+sday+'*v05.10_r01_cld.nc',fnamescld
...
;
          good=where(FINITE(ALB) EQ 1 and latitude ge 50.,ngood)
...
;
             if setplot eq 'ps' then begin
                ...
                device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
                       /bold,/color,bits_per_pixel=8,/helvetica,filename='polar_daily_cipsl2+l3a_v5.0_'+sdate+'.ps'
                !p.charsize=1.25
                !p.thick=2
                !p.charthick=5
                !y.thick=2
             ...
             !type=2^2+2^3
             map_set,90,0,0,/ortho,/contin,/grid,/noeras,color=0,title=sdate+' DOY='+sday,charsize=2,limit=[50.,0.,90.,360.]
         endif
         oplot,longitude,latitude,psym=8,symsize=0.5,color=col1(iorbit)
...
;
     sday=string(format='(i3.3)',iday)
     ifile='/Volumes/Data/CIPS_data/Datfiles/cips_sci_3a_2016-'+sday+'_v05.00_r01.nc'
;    restore,'read_cips_file/read_cips_file.sav
