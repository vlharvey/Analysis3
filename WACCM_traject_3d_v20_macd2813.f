...
c
      ...
      real arr14(nrmax,ncmax,nthwmx),arr15(nrmax,ncmax,nthwmx)
c
      logical ex0  
c
...
c get dimensions
        ...
        nthw=nth
        ifirst=0
        call rdwind(ncid,arr1,arr2,arr3,arr4,arr5,arr6,
     1      arr7,arr8,arr9,arr10,arr11,arr12,arr13,arr14,arr15,
...
C
      ...
      subroutine rdwind(ncid,arr1,arr2,arr3,arr4,arr5,arr6,
     1      arr7,arr8,arr9,arr10,arr11,arr12,arr13,arr14,arr15,
     2      nrw,ncw,nthw,ifirst)
c
c*****************************************************************c
...
c
     ...
     5          arr14(nrw,ncw,nthw),arr15(nrw,ncw,nthw)
      data istart/1,1,1/
      icount(1)=nrw
      icount(2)=ncw
      icount(3)=nthw
      ...
      call ncvgt(ncid, 4, istart, icount, arr4, iret)		! PV
      call ncvgt(ncid, 5, istart, icount, arr5, iret)		! P
      call ncvgt(ncid, 6, istart, icount, arr6, iret)		! U
      call ncvgt(ncid, 7, istart, icount, arr7, iret)		! V
      call ncvgt(ncid, 8, istart, icount, arr8, iret)		! Q
      call ncvgt(ncid, 9, istart, icount, arr9, iret)		! QDF
      call ncvgt(ncid, 10, istart, icount, arr10, iret)		! GPH
      call ncvgt(ncid, 11, istart, icount, arr11, iret)		! SF
      call ncvgt(ncid, 12, istart, icount, arr12, iret)		! MARK
      call ncvgt(ncid, 13, istart, icount, arr13, iret)		! H2O
      call ncvgt(ncid, 14, istart, icount, arr14, iret)		! N2O
      call ncvgt(ncid, 15, istart, icount, arr15, iret)		! O3
      ...
      do i=1,nc
        do j=1,nr
          do l=1,nth
             ...
             qsim(j,i,l)=arr8(j,i,l)/86400.     ! K/day -> K/s
             qdfsim(j,i,l)=arr9(j,i,l)
             xmsfsim(j,i,l)=arr11(j,i,l)	! SF
             xmrksim(j,i,l)=arr12(j,i,l)        ! MARK
             xnosim(j,i,l)=arr13(j,i,l)		! H2O
             xcosim(j,i,l)=arr15(j,i,l)		! O3
          enddo
        enddo
      enddo
      return
