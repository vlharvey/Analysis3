;
; create WACCM4 noaur yearly files of surface temperature
;
@stddat
@kgmt
@ckday
...
;
      if icount eq 0L then TSNAFPL_avg=fltarr(nc,nr,kday)
;
; loop over years and retain all data
;
;     print,'restored '+dum(0)
      TSNAFPL_avg(*,*,icount)=ts
;
jumpday:
      icount=icount+1L
goto,jump
...
print,'saved '+ofile
save,file=ofile,sdate_all,lat,lon,TSNAFPL_avg
