...
; Input data:  IDL>restore,'/Volumes/Data/WACCM/WACCM4/mee00fpl_FW2.cam2.h3.dyns.20421231_3D_dyn.nc
; dimensions:
...
;                GPH:units = "m" ;
;        float TTGW(number_of_levels, number_of_longitudes, number_of_latitudes) ;
;                TTGW:longname = "Temperature Tendency due to Gravity Waves" ;
;                TTGW:units = "K/day" ;
;loadct,39
;device,decompose=0
;mcolor=byte(!p.color)
...
;
ofile=dirw+'mee00fpl_FW2.cam2.h3.dyns.'+sdate+'_3D_dyn.nc2'
print,'writing ',ofile
nocid = ncdf_create(ofile,/CLOBBER)
...
ncdf_varput, nocid, 'TTGW', ttgwgrd    , COUNT=[nr,nc,nl]
