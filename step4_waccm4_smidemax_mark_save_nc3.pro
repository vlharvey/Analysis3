...
ifiles=file_search(dirw+'3d_CO2x1SmidEmax_yBWCN_???????.nc2',count=nfile)
;
; loop over files
;
...
;
    result=file_search(dirw+'3d_CO2x1SmidEmax_yBWCN_'+sdate+'.nc3')
...
; write marker file
;
ofile=dirw+'3d_CO2x1SmidEmax_yBWCN_'+sdate+'.nc3'
;
