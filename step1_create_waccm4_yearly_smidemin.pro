...
ifiles=idir+ivars+'_CO2x1SmidEmin_yBWCN_vE.sav'
...
if ivars(ii) eq 'CLONO2' then save,CLONO2_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'CO' then CO_YEARLY=reform(CO(*,*,index))
if ivars(ii) eq 'CO' then save,CO_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'DTCORE' then DTCORE_YEARLY=reform(DTCORE(*,*,index))
if ivars(ii) eq 'DTCORE' then save,DTCORE_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'DTV' then DTV_YEARLY=reform(DTV(*,*,index))
if ivars(ii) eq 'DTV' then save,DTV_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'EKGWSPEC' then begin
   EKGWSPEC_YEARLY=reform(EKGWSPEC(*,*,index))
   ilev=float(ilev)
   save,EKGWSPEC_YEARLY,LAT,ILEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
endif
if ivars(ii) eq 'NO2' then NO2_YEARLY=reform(NO2(*,*,index))
if ivars(ii) eq 'NO2' then save,NO2_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'NO' then NO_YEARLY=reform(NO(*,*,index))
if ivars(ii) eq 'NO' then save,NO_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'NOx' then NOx_YEARLY=reform(NOx(*,*,index))
if ivars(ii) eq 'NOx' then save,NOx_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'NOy' then NOy_YEARLY=reform(NOy(*,*,index))
if ivars(ii) eq 'NOy' then save,NOy_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'O3' then O3_YEARLY=reform(O3(*,*,index))
if ivars(ii) eq 'O3' then save,O3_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'OMEGA' then OMEGA_YEARLY=reform(OMEGA(*,*,index))
if ivars(ii) eq 'OMEGA' then save,OMEGA_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'PSL' then begin
   lon=float(lon)
   PSL_YEARLY=reform(PSL(*,*,index))
   save,PSL_YEARLY,LAT,LON,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
endif
if ivars(ii) eq 'PTTEND' then PTTEND_YEARLY=reform(PTTEND(*,*,index))
if ivars(ii) eq 'PTTEND' then save,PTTEND_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'P' then P_YEARLY=reform(P(*,*,index))
if ivars(ii) eq 'P' then save,P_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'QCP' then QCP_YEARLY=reform(QCP(*,*,index))
if ivars(ii) eq 'QCP' then save,QCP_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'QJOULE' then QJOULE_YEARLY=reform(QJOULE(*,*,index))
if ivars(ii) eq 'QJOULE' then save,QJOULE_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'QNO' then QNO_YEARLY=reform(QNO(*,*,index))
if ivars(ii) eq 'QNO' then save,QNO_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'QRLNLTE' then QRLNLTE_YEARLY=reform(QRLNLTE(*,*,index))
if ivars(ii) eq 'QRLNLTE' then save,QRLNLTE_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'QRL' then QRL_YEARLY=reform(QRL(*,*,index))
if ivars(ii) eq 'QRL' then save,QRL_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'QRS_AUR' then QRS_AUR_YEARLY=reform(QRS_AUR(*,*,index))
if ivars(ii) eq 'QRS_AUR' then save,QRS_AUR_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'QRS_CO2NIR' then QRS_CO2NIR_YEARLY=reform(QRS_CO2NIR(*,*,index))
if ivars(ii) eq 'QRS_CO2NIR' then save,QRS_CO2NIR_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'QRS' then QRS_YEARLY=reform(QRS(*,*,index))
if ivars(ii) eq 'QRS' then save,QRS_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'QRS_EUV' then QRS_EUV_YEARLY=reform(QRS_EUV(*,*,index))
if ivars(ii) eq 'QRS_EUV' then save,QRS_EUV_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'QRS_LO3A' then QRS_LO3A_YEARLY=reform(QRS_LO3A(*,*,index))
if ivars(ii) eq 'QRS_LO3A' then save,QRS_LO3A_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'QRS_LO3B' then QRS_LO3B_YEARLY=reform(QRS_LO3B(*,*,index))
if ivars(ii) eq 'QRS_LO3B' then save,QRS_LO3B_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'QRS_LO3' then QRS_LO3_YEARLY=reform(QRS_LO3(*,*,index))
if ivars(ii) eq 'QRS_LO3' then save,QRS_LO3_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'QRS_SO2A' then QRS_SO2A_YEARLY=reform(QRS_SO2A(*,*,index))
if ivars(ii) eq 'QRS_SO2A' then save,QRS_SO2A_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'QRS_SO2B' then QRS_SO2B_YEARLY=reform(QRS_SO2B(*,*,index))
if ivars(ii) eq 'QRS_SO2B' then save,QRS_SO2B_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'QRS_SO3A' then QRS_SO3A_YEARLY=reform(QRS_SO3A(*,*,index))
if ivars(ii) eq 'QRS_SO3A' then save,QRS_SO3A_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'QRS_SO3B' then QRS_SO3B_YEARLY=reform(QRS_SO3B(*,*,index))
if ivars(ii) eq 'QRS_SO3B' then save,QRS_SO3B_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'QSUM' then QSUM_YEARLY=reform(QSUM(*,*,index))
if ivars(ii) eq 'QSUM' then save,QSUM_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'QTHERMAL' then QTHERMAL_YEARLY=reform(QTHERMAL(*,*,index))
if ivars(ii) eq 'QTHERMAL' then save,QTHERMAL_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'TAUX' then begin
   lon=float(lon)
   TAUX_YEARLY=reform(TAUX(*,*,index))
   save,TAUX_YEARLY,LAT,LON,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
endif
if ivars(ii) eq 'TAUY' then begin
   lon=float(lon)
   TAUY_YEARLY=reform(TAUY(*,*,index))
   save,TAUY_YEARLY,LAT,LON,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
endif
if ivars(ii) eq 'TS' then begin
   lon=float(lon)
   TS_YEARLY=reform(TS(*,*,index))
   save,TS_YEARLY,LAT,LON,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
endif
if ivars(ii) eq 'TTEND' then TTEND_YEARLY=reform(TTEND(*,*,index))
if ivars(ii) eq 'TTEND' then save,TTEND_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'TTGW' then TTGW_YEARLY=reform(TTGW(*,*,index))
if ivars(ii) eq 'TTGW' then save,TTGW_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'T' then T_YEARLY=reform(T(*,*,index))
if ivars(ii) eq 'T' then save,T_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'UTGWSPEC' then UTGWSPEC_YEARLY=reform(UTGWSPEC(*,*,index))
if ivars(ii) eq 'UTGWSPEC' then save,UTGWSPEC_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'U' then U_YEARLY=reform(U(*,*,index))
if ivars(ii) eq 'U' then save,U_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'V' then V_YEARLY=reform(V(*,*,index))
if ivars(ii) eq 'V' then save,V_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
if ivars(ii) eq 'Z3' then Z3_YEARLY=reform(Z3(*,*,index))
if ivars(ii) eq 'Z3' then save,Z3_YEARLY,LAT,LEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'

if ivars(ii) eq 'Vstar' then begin
   VSTAR_YEARLY=reform(VSTAR(*,*,index))
   ilev=float(ilev)
   save,VSTAR_YEARLY,LAT,ILEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
endif
if ivars(ii) eq 'Wstar' then begin
   WSTAR_YEARLY=reform(WSTAR(*,*,index))
   ilev=float(ilev)
   save,WSTAR_YEARLY,LAT,ILEV,SDATE_ALL,filename=dir+ivars(ii)+'_CO2x1SmidEmin_yBWCN_vE_Year'+y(index(0))+'.sav'
endif
