...
; --- Test for end condition and close windows.
      ...
      rd_sdwaccm4_nc3_new,ifile,nc,nr,nth,alon,alat,th,$
         pv2,p2,z2,u2,v2,q2,qdf2,mark2,sf2,h2o2,n2o2,o32,co22,no2,no22,iflg
...
; save postscript version
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='3D_Arctic_vortex/'+sdate+'_sdwaccm_new_3D_arctic_vortex.ps'
       device,/color
...
;          contour,temp,xcn,ycn,levels=[290.,300.,310.],color=0,/T3D,zvalue=nz,thick=2,min_value=-1.e15
           if th(lev) gt 2000. then contour,temp,xcn,ycn,levels=[120,130,140,150,160],c_color=[20,50,70,90,110],/T3D,zvalue=nz,thick=10,min_value=-1.e15
...
;   xyouts,.08,.9,'Theta (K)',charsize=2,/normal,color=0,charthick=2
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim '+'3D_Arctic_vortex/'+sdate+'_sdwaccm_new_3D_arctic_vortex.ps -rotate -90 '+'3D_Arctic_vortex/'+sdate+'_sdwaccm_new_3D_arctic_vortex.jpg'
       spawn,'rm -f '+'3D_Arctic_vortex/'+sdate+'_sdwaccm_new_3D_arctic_vortex.ps'
    endif
