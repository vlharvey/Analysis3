...
; comment this out and plot yrange=[-5,5]
    contour,tbar,alat,zbar,/fill,c_color=col1,levels=level,xrange=[0.,90.],yrange=[60.,90.],ytitle='Geopotential Height (km)',xtitle='Latitude'
...
;   coinindex=where(tmp0 lt 160. and long0 gt 100. and long0 lt 300. and xx0 ge 50. and xx0 le 70.,ncoin)   ; MIL
    coinindex=where(q0 lt 0. and tmp0 lt 188. and xx0 ge 50. and xx0 le 70.,ncoin)   ; MIL
