pro rd_sdwaccm4_nc3_new,file1,nc,nr,nth,alon,alat,thlev,$
    ipv,prs,gph,u,v,q,qdf,marksf,sf,h2o,n2o,o3,co2,no,no2,iflg
iflg=0
dum1=findfile(file1)
...
;       print,'read ',name,' dimension ',dim
    ...
    for ivar=0,result0.nvars-1 do begin
        ...
        if result.name eq 'CO2' then co2=data              ; carbon dioxide
        if result.name eq 'NO' then no=data              ; nitric oxide
        if result.name eq 'NO2' then no2=data              ; nitrogen dioxide
