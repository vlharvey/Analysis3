...
; read SDWACCM-D hs netcdf data files from Josh Pettit
...
;   ncdf_varget,ncid,varid,ch4data	; this variable is missing
...
;   varid = ncdf_varid(ncid,'H2O')	; this variable is missing
;   ncdf_varget,ncid,varid,h2odata
;   varid = ncdf_varid(ncid,'CO2')	; this variable is missing
