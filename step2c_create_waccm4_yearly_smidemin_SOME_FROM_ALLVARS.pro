...
for iyr=1,300 do begin		; all years from set1
    ...
    ifiles=dir+'ALLVARS_CO2x1SmidEmin_yBWCN_vE_Year'+syr+'.sav'
...
;
    save,filename=dir+'SOMEVARS_CO2x1SmidEmin_yBWCN_vE_Year'+syr+'.sav',LAT,LEV,ILEV,SDATE_ALL,$
         CLONO2,NOx,NOy,O3,QRS_LO3A,QRS_LO3B,QRS_SO3A,QRS_SO3B,T,U,Z3,WSTAR
print,'saved '+'SOMEVARS_CO2x1SmidEmin_yBWCN_vE_Year'+syr+'.sav'
if iyr eq 1 then begin
;  erase
;  !type=2^2+2^3
;  plot,NOx(0,26,*)*1.e9,ytitle='NOx (ppbv) at 90S and 1hPa',yrange=[0,50],xtitle='DOY',color=0,charsize=2,title='FR-WACCM CO2x1SmidEmin_yBWCN_vE'
endif
