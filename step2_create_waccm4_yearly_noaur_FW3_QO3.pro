...
;
      if icount eq 0L then begin
         QRS_SO3ANAFPL_avg=fltarr(nr,nl,kday)
         QRS_SO3BNAFPL_avg=fltarr(nr,nl,kday)
         QRS_LO3ANAFPL_avg=fltarr(nr,nl,kday)
         QRS_LO3BNAFPL_avg=fltarr(nr,nl,kday)
         QRS_LO3NAFPL_avg=fltarr(nr,nl,kday)
      endif
;
; loop over years and retain all data
;
      print,'restored '+dum(0)
      QRS_SO3ANAFPL_avg(*,*,icount)=QRS_SO3ANAFPL
      QRS_SO3BNAFPL_avg(*,*,icount)=QRS_SO3BNAFPL
      QRS_LO3ANAFPL_avg(*,*,icount)=QRS_LO3ANAFPL
      QRS_LO3BNAFPL_avg(*,*,icount)=QRS_LO3BNAFPL
      QRS_LO3NAFPL_avg(*,*,icount)=QRS_LO3NAFPL
;
jumpday:
      icount=icount+1L
goto,jump
...
save,file=ofile,sdate_all,lat,lev,QRS_SO3ANAFPL_avg,QRS_SO3BNAFPL_avg,QRS_LO3ANAFPL_avg,QRS_LO3BNAFPL_avg,QRS_LO3NAFPL_avg
