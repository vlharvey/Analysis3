...
; MIPAS
;
; /Volumes/cloud/data/WACCM_data/Datfiles_SD/f_1975-2010_2deg_refc1sd_wa4_tsmlt.002.cam.hs.*MLS_etal.sav
;
; CO, NO, NO2, T, Z3
;
dir='/Volumes/cloud/data/WACCM_data/Datfiles_SD/'
spawn,'ls '+dir+'f_1975-2010_2deg_refc1sd_wa4_tsmlt.002.cam.hs.2004*.nc',ifiles
