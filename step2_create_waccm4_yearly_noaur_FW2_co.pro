;
; create WACCM4 noaur yearly files of CO
;
@stddat
@kgmt
@ckday
...
spawn,'ls '+dirh+'*0101_CO.sav',ifiles
...
; read WACCM data
;
      dum=findfile(dirh+'Year'+model_years(iyear)+'_'+sdate+'_CO.sav')
...
;
saveit:
ofile=dirh+'Year'+model_years(iyear)+'_VLH_CO.sav'
print,'saved '+ofile
save,file=ofile,sdate_all,lat,lev,CONAFPL_avg
