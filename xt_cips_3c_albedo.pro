...
contour,smooth(array,5,/NaN,/edge_truncate),lonbin,ddd,levels=level,c_color=col1,/cell_fill,xticks=6,$
        title=season+' '+SNODE+' '+slat+'!uo!n Lat',xtitle='Longitude',/noeras,color=0,xrange=[0,360]
contour,smooth(array,5,/NaN,/edge_truncate),lonbin,ddd,levels=2*level,color=0,/overplot,/noeras,$
