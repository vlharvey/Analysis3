...
spawn,'ls '+dirh+'*0101_TTGW.sav',ifiles
...
; read WACCM data
;
      dum=findfile(dirh+'Year'+model_years(iyear)+'_'+sdate+'_TTGW.sav')
...
;
      if icount eq 0L then begin
         TTGW00FPL_avg=fltarr(nr,nl,kday)
      endif
;
; loop over years and retain all data
;
      print,'restored '+dum(0)
      TTGW00FPL_avg(*,*,icount)=TTGW00FPL
;
jumpday:
      icount=icount+1L
goto,jump
...
;
saveit:
ofile=dirh+'Year'+model_years(iyear)+'_VLH_TTGW.sav'
save,file=ofile,sdate_all,lat,lev,TTGW00FPL_avg
