...
spawn,'ls '+dirh+'*0101_DTV.sav',ifiles
...
; read WACCM data
;
      dum=findfile(dirh+'Year'+model_years(iyear)+'_'+sdate+'_DTV.sav')
...
;
      if icount eq 0L then begin
         DTVNAFPL_avg=fltarr(nr,nl,kday)
      endif
;
; loop over years and retain all data
;
      print,'restored '+dum(0)
      DTVNAFPL_avg(*,*,icount)=DTVNAFPL
;
jumpday:
      icount=icount+1L
goto,jump
...
;
saveit:
ofile=dirh+'Year'+model_years(iyear)+'_VLH_DTV.sav'
save,file=ofile,sdate_all,lat,lev,DTVNAFPL_avg
