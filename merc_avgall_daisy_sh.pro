...
;
spawn,'ls '+pth+'*_v04.20_sh.sav',ifiles
...
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='merc_avgall_daisy_sh.ps'
   !p.charsize=1.5
   !p.thick=1.5
   !p.charthick=5
   !p.charthick=5
...
map_set,0,0,0,/contin,/grid,color=0,/noeras,title='CIPS L3 V4.20 SH 2007-2011',limit=[-80, 0, -50, 360]
...
if setplot eq 'ps' then begin
   device, /close
   spawn,'convert -trim merc_avgall_daisy_sh.ps -rotate -90 merc_avgall_daisy_sh.jpg'
;  spawn,'rm -f merc_avgall_daisy_sh.ps'
endif
end
