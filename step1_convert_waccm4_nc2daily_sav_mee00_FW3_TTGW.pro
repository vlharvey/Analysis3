...
spawn,'ls '+dir+'mee00fpl_FW3NoSpin_paper1_Press_*TTGW.sav',ifiles
...
;
    ...
    TTGW00FPL=reform(TTGW00FPL_all(*,*,ifile))
    ofile=dir+'mee00fpl_FW3.cam2.h3.Year'+syear(ifile)+'_'+smon(ifile)+sday(ifile)+'_TTGW.sav'
    print,ofile
    save,file=ofile,LAT,LEV,DATE00FPL,TTGW00FPL
