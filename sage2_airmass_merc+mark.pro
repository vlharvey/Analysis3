...
; plot UKMO quantity in top panel
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='sage2_o3_'+stheta+$
...
;    o3min=0.
    ...
    xyouts,.35,.8,'SAGE II Ozone '+stheta,/normal,charsize=2
...
; color bar for Ozone data
    ...
    if setplot eq 'ps' then begin
       device, /close
       spawn,'convert sage2_o3_'+stheta+'_'+stime+'+mark_merc.ps -rotate -90 '+$
             ' sage2_o3_'+stheta+'_'+stime+'+mark_merc.jpg'
    endif
