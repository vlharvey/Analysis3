pro write_sdwaccm4_nc3,ofile,nc,nr,nth,alon,alat,thlev,$
          ipv,prs,gph,u,v,q,qdf,mark,sf,h2o,n2o,o3
;
...
ncdf_varput, nocid, 'H2O'  , h2o      , COUNT=[nr,nc,nth]
ncdf_varput, nocid, 'N2O'  , n2o      , COUNT=[nr,nc,nth]
ncdf_varput, nocid, 'O3'  , o3      , COUNT=[nr,nc,nth]
ncdf_close,nocid
return
end
