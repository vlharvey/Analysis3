...
ifiles=file_search(dirw+'mee00fpl_FW2.cam2.h3.dyns.*_3D_dyn.nc2',count=nfile)
;
; loop over files
;
...
;       print,'read ',name,' dimension ',dim
    ...
    for ivar=0,result0.nvars-1 do begin
        ...
        if result.name eq 'TTGW' then ttgw2=data		; Temperature Tendency due to Gravity Waves (K/day)
...
; write marker file
;
ofile=dirw+'mee00fpl_FW2.cam2.h3.dyns.'+sdate+'_3D_dyn.nc3'
write_waccm4_nc3,ofile,nc,nr,nth,alon,alat,th,pv2,p2,g2,u2,v2,q2,qdf2,mark2,ttgw2,sf2
