...
; Input data:  IDL>restore,'/atmos/harvey/WACCM_data/Datfiles/Datfiles_Ethan_600yr/CO2x1SmidEmin_yBWCN/3d_CO2x1SmidEmin_yBWCN_YYYMMDD_vE.sav'
...
ifiles=file_search(dirw+'3d_CO2x1SmidEmin_yBWCN_*.sav',count=nfile)
;
; loop over files
;
...
;
    result=file_search(dirw+'3d_CO2x1SmidEmin_yBWCN_'+sdate+'.nc')
...
;
ofile=dirw+'3d_CO2x1SmidEmin_yBWCN_'+sdate+'.nc'
print,'writing ',ofile
