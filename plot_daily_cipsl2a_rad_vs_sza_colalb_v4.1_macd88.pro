...
if iorbit eq 0L then begin
   if setplot eq 'ps' then begin
      ...
      device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
             /bold,/color,bits_per_pixel=8,/helvetica,filename='plot_daily_cipsl2_rad_vs_sza_colalb_v4.1_'+sdate+'.ps'
      !p.charsize=1.5
      !p.thick=1.5
      !p.charthick=5
      !p.charthick=5
...
; Close PostScript file and return control to X-windows
     ...
     if setplot eq 'ps' then begin
        device, /close
        spawn,'convert -trim plot_daily_cipsl2_rad_vs_sza_colalb_v4.1_'+sdate+'.ps -rotate -90 '+$
                            'plot_daily_cipsl2_rad_vs_sza_colalb_v4.1_'+sdate+'.jpg'
        spawn,'rm -f plot_daily_cipsl2_rad_vs_sza_colalb_v4.1_'+sdate+'.ps'
     endif
