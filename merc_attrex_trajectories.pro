...
nh=1
ifilet=['../geos5_20130205_attrex.traj']
...
nn=0
    ...
    nmax=600000l
      ...
      nfile=0L
      wfile='DAS.ops.asm.tavg3d_dyn_v.GEOS520.MetO.20130205_AVG.V01.nc3'
      istime=0l
      ictime=0l
      dtflow=0.
      dt=0.
      ...
      attrex=' '
      diratt='/Volumes/Data/ATTREX_data/Datfiles/'
      nattrex=0L
      attfile='ATTREX_20130205.nc'
      dtout=0.
      ofile='                                          '
      nr=0L
      nc=0L
...
;   MAP_SET,0,0,0,/GRID,/contin,charsize=2,/noeras,color=0,title='ATTREX '+stime0,/hires,/usa,limit=[min(ysave)-5.,min(xx0)-45.,max(ysave)+5.,max(xx0)+45.]
    MAP_SET,0,0,0,/GRID,/contin,charsize=2,/noeras,color=0,title='ATTREX '+stime0,/hires,/usa,limit=[-30.,180.,60.,360.]
