...
;spawn,'ls '+dir+'f_1975-2010_2deg_refc1sd_wa4_tsmlt.002.cam.hs.20??-*.nc',ifiles
spawn,'ls '+dir+'f.e11.FWTREFC1SD.f19.f19.ccmi30.001.cam.hs.20??-*.nc',ifiles
nfiles=n_elements(ifiles)
for ifile=73L,nfiles-1L do begin	; begin Aug 2004 MLS
;
; read WACCM data
;
