...
xmin=1.
xmax=41.
xindex=where(dfs ge xmin and dfs le xmax)
dfs=dfs(xindex)
alb=alb(xindex,*)
mls_tp=mls_tp(xindex,*)
...
shade_surf,smooth(alb,3),dfs,latlo,xtitle='DFS 20'+syr,ytitle='PM     Latitude     AM',color=0,ztitle='CIPS Albedo (Garys)',charsize=3,ytickv=latlo(index),$
        ...
        zticks=3,ztickv=[10,20,30,40],zrange=[0,40],/save,shades=bytscl(smooth(mls_tp,3),tmin,tmax),pixels=result(4),xrange=[xmin,xmax]
