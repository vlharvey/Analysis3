...
;
plotit:
;restore,'yt_nh_pre_'+syear+'_QF01_ALB1.sav'	;,asc_freq,des_freq,dfs,latbin,syear,szamax_asc,szamin_asc,albmax_asc,albmin_asc,szamax_des,szamin_des,albmax_des,albmin_des
if setplot eq 'ps' then begin
   ...
   device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
          /bold,/color,bits_per_pixel=8,/helvetica,filename='yt_cloud_freq_v4.2_'+syear+'_nh_pre.ps'
   !p.charsize=1.5
   !p.thick=1.5
   !p.charthick=5
   !p.charthick=5
...
save,file='yt_nh_pre_'+syear+'_QF01_ALB1.sav',asc_freq,des_freq,dfs,latbin,syear,$
...
; Close PostScript file and return control to X-windows
 ...
 if setplot eq 'ps' then begin
    device, /close
    spawn,'convert -trim yt_cloud_freq_v4.2_'+syear+'_nh_pre.ps -rotate -90 '+$
                        'yt_cloud_freq_v4.2_'+syear+'_nh_pre.jpg'
    spawn,'rm -f yt_cloud_freq_v4.2_'+syear+'_nh_pre.ps'
 endif
end
