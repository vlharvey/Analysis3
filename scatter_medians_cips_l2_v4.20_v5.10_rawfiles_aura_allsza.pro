...
erase
      if setplot eq 'ps' then begin
         ...
         device,/landscape,/inch,xoff=4.25-ysize/2.,yoff=5.5+xsize/2.,xsize=xsize,ysize=ysize,$
                /bold,/color,bits_per_pixel=8,/helvetica,filename='scatter-6pan_cips_l4_v4.20_v5.10_rawfiles_north_allsza.ps'
         !p.charsize=1.2
         !p.thick=2
         !p.charthick=5
         !y.thick=2
...
index=where(med51 gt 0. and med20 gt 0.)
plot,med20(index),med51(index),color=0,psym=8,symsize=1,ytitle='5.1 ALB',xtitle='4.2 ALB',xrange=[0,50],yrange=[0,50],charsize=1.2,charthick=2,/noeras,/nodata
    index=where(y2d ge 40. and y2d lt 50 and med51 gt 0. and med20 gt 0.)	; DES
    oplot,med20(index),med51(index),color=0,psym=8,symsize=0.5
    result=linfit(med20(index),med51(index),yfit=linevals)
    b=result(0)
    slope=result(1)
    y=slope*x+b
    oplot,x,y,thick=3,color=0

    index=where(y2d ge 50. and y2d lt 60 and med51 gt 0. and med20 gt 0.)       ; DES
    oplot,med20(index),med51(index),color=60,psym=8,symsize=0.5
    result=linfit(med20(index),med51(index),yfit=linevals)
    b=result(0)
    slope=result(1)
    y=slope*x+b
    oplot,x,y,thick=3,color=60

    index=where(y2d ge 60. and y2d lt 70 and med51 gt 0. and med20 gt 0.)       ; DES
    oplot,med20(index),med51(index),color=150,psym=8,symsize=0.5
    result=linfit(med20(index),med51(index),yfit=linevals)
    b=result(0)
    slope=result(1)
    y=slope*x+b
    oplot,x,y,thick=3,color=150

    index=where(y2d ge 70. and y2d lt 80 and med51 gt 0. and med20 gt 0.)       ; DES
    oplot,med20(index),med51(index),color=200,psym=8,symsize=0.5
    result=linfit(med20(index),med51(index),yfit=linevals)
    b=result(0)
    slope=result(1)
    y=slope*x+b
    oplot,x,y,thick=3,color=200

    index=where(y2d ge 80. and y2d lt 90 and med51 gt 0. and med20 gt 0.)       ; DES
    oplot,med20(index),med51(index),color=220,psym=8,symsize=0.5
    result=linfit(med20(index),med51(index),yfit=linevals)
    b=result(0)
    slope=result(1)
    y=slope*x+b
    oplot,x,y,thick=3,color=220

    index=where(y2d ge 90. and y2d lt 100 and med51 gt 0. and med20 gt 0.)       ; DES
    oplot,med20(index),med51(index),color=250,psym=8,symsize=0.5
    result=linfit(med20(index),med51(index),yfit=linevals)
    b=result(0)
    slope=result(1)
    y=slope*x+b
    oplot,x,y,thick=3,color=250


xyouts,xorig(1)+xlen+0.02,yorig(1)+0.02,'40-50',/normal,color=0,charthick=2
xyouts,xorig(1)+xlen+0.02,yorig(1)+0.04,'50-60',/normal,color=60,charthick=2
xyouts,xorig(1)+xlen+0.02,yorig(1)+0.06,'60-70',/normal,color=150,charthick=2
xyouts,xorig(1)+xlen+0.02,yorig(1)+0.08,'70-80',/normal,color=200,charthick=2
xyouts,xorig(1)+xlen+0.02,yorig(1)+0.10,'80-90',/normal,color=220,charthick=2
xyouts,xorig(1)+xlen+0.02,yorig(1)+0.12,'90-100',/normal,color=250,charthick=2
xyouts,xorig(1)+xlen+0.02,yorig(1)+0.14,'SZA',/normal,color=0,charthick=2
...
oplot,level,level,thick=2,color=0
    ...
    if setplot eq 'ps' then begin
       device, /close
       spawn,'convert -trim scatter-6pan_cips_l4_v4.20_v5.10_rawfiles_north_allsza.ps -rotate -90 scatter-6pan_cips_l4_v4.20_v5.10_rawfiles_north_allsza.jpg'
;      spawn,'rm -f scatter-6pan_cips_l4_v4.20_v5.10_rawfiles_north_allsza.ps'
    endif
end
