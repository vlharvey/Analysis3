...
dum=1979+indgen(25)
syear=strcompress(dum,/remove_all)	; 1979-2003
...
dum=findfile('ztd+vortex_shape_merra_'+syear(iyear)+smon(imon)+'.sav')
...
ztd=smooth(ztd,3,/nan)
save,filename='vortex_shape_merra_'+syear(iyear)+smon(imon)+'.sav',nth,nfile,th,sdate_all,centroid_longitude1,area1,$
