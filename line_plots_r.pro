...
;array(*,35:69) is descending.
   ...
   plot,[0,0],[0,0],/nodata,title='Ascending Radius'
   ...
   plot,[0,0],[0,0],/nodata,title='Descending Radius'
   for ll=0,nlats-1 do begin
      li=where(round(lat) eq lats(ll))
   ...
   plot,[0,0],[0,0],/nodata,title='Radius, 85!uo!n'+shem
   ...
   plot,[0,0],[0,0],/nodata,title='Radius, 70!uo!n'+shem
