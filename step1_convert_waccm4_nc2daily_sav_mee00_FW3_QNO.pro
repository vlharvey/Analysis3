...
ifiles=dir+['mee00fpl_FW3NoSpin_paper1_Press_QNO.sav']
...
;
    ...
    QNO00FPL=reform(QNO00FPL_all(*,*,ifile))
    ofile=dir+'mee00fpl_FW3.cam2.h3.Year'+syear(ifile)+'_'+smon(ifile)+sday(ifile)+'_QNO.sav'
    print,ofile
    save,file=ofile,LAT,LEV,DATE00FPL,QNO00FPL
