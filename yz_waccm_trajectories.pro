...
;   contour,qbar,alat,th,/fill,c_color=col1,levels=level,xrange=[-90.,-40.],yrange=[4920.,5005.],/nodata
    contour,qbar,alat,th,/fill,c_color=col1,levels=level,xrange=[-90.,-40.],yrange=[79.,85.],/nodata,ytitle='Geopotential Height (km)',xtitle='Latitude'
    index=where(level lt 0.)
;   contour,qbar,alat,th,/follow,color=mcolor,c_linestyle=1,levels=level(index),/overplot
    index=where(level gt 0.)
;   contour,qbar,alat,th,/follow,color=0,c_linestyle=0,levels=level(index),/overplot
;   contour,tbar,alat,th,/follow,color=0,c_linestyle=0,levels=[130.],/overplot,thick=5
