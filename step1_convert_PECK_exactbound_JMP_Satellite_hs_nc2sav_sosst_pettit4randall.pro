...
;
; /atmos/Pettit/RAISE_MEE_Simulations/PECK_exactbound_JMP_Satellite/PECK_CCMI-34_exactbound_jmp.cam2.satellite.2004-01-01-00000.nc
;
; CO, NO, NO2, T, Z3
;
@mkltime

;dir='/atmos/Pettit/RAISE_MEE_Simulations/PECK_exactbound_JMP_Satellite/'
dir='/atmos/Pettit/RAISE_MEE_Simulations/PECK_Exact_Lshell/PECK_Exact_Lshell_Satellite/'
;spawn,'ls '+dir+'PECK_CCMI-34_exactbound_jmp.cam2.satellite.2004-*.nc',ifiles
spawn,'ls '+dir+'NEW_PECK_CCMI-34.cam2.satellite.200?-*.nc',ifiles
...
; Calculate APPROXIMATE GPH - need to output Z3 in any publication quality analysis- this is now done
;
