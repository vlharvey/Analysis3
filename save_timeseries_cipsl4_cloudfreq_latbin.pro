;
; read daily CIPS IDL save files of cloud frequency binned every 5 degrees latitude
...
;fdoy_all=fltarr(kday)
    ...
    imax=100.
    ndoy=365
    plot,findgen(ndoy),cloud_freq_max_lat,ytitle='Cloud Frequency (%)',yrange=[imin,imax],$
