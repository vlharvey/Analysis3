...
; variables: QRS_LO3A QRS_LO3B DTV QRS_SO3B
;
...
ifiles=dir+['mee00fpl_FW3NoSpin_paper1_Press_DTV.sav']
...
;
    ...
    DTV00FPL=reform(DTV00FPL_all(*,*,ifile))
    ofile=dir+'mee00fpl_FW3.cam2.h3.Year'+syear(ifile)+'_'+smon(ifile)+sday(ifile)+'_DTV.sav'
    print,ofile
    save,file=ofile,LAT,LEV,DATE00FPL,DTV00FPL
