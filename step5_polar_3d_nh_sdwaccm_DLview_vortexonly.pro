...
; save postscript version
    if setplot eq 'ps' then begin
       ...
       !p.font=0
       device,font_size=9
       device,/landscape,bits=8,filename='3D_Arctic_vortex/'+sdate+'_sdwaccm_3D_arctic_vortex.ps'
       device,/color
...
;                  /T3D,zvalue=nz,thick=3,min_value=-1.e15
...
jumplev:
    ...
    if setplot eq 'ps' then begin
       device,/close
       spawn,'convert -trim '+'3D_Arctic_vortex/'+sdate+'_sdwaccm_3D_arctic_vortex.ps -rotate -90 '+'3D_Arctic_vortex/'+sdate+'_sdwaccm_3D_arctic_vortex.jpg'
       spawn,'rm -f '+'3D_Arctic_vortex/'+sdate+'_sdwaccm_3D_arctic_vortex.ps'
    endif
