...
spawn,'ls '+dirh+'*0101_QNO.sav',ifiles
...
; read WACCM data
;
      dum=findfile(dirh+'Year'+model_years(iyear)+'_'+sdate+'_QNO.sav')
...
;
      if icount eq 0L then begin
         QNO00FPL_avg=fltarr(nr,nl,kday)
      endif
;
; loop over years and retain all data
;
      print,'restored '+dum(0)
      QNO00FPL_avg(*,*,icount)=QNO00FPL
;
jumpday:
      icount=icount+1L
goto,jump
...
;
saveit:
ofile=dirh+'Year'+model_years(iyear)+'_VLH_QNO.sav'
save,file=ofile,sdate_all,lat,lev,QNO00FPL_avg
