;
; read CIPS level 2a version 4.01 data and plot albedo for all orbits each day
;
loadct,39
mcolor=!p.color
...
; loop over orbits
;
      FOR iorbit = 1,norbit-1 DO BEGIN
...
;                   (CLOUD_INDEX EQ 1 OR CLOUD_INDEX EQ 0) AND $
          ...
          ENDIF
print,'Min Latitude ',min(latitude)
stop
;
; plot clouds color by brightness
;
if iorbit eq 1L then begin
;
; postscript file
;
...
;       spawn,'/usr/bin/rm polar_daily_cipsl2_alb_v4.1_'+sdate+'.ps'
     endif
