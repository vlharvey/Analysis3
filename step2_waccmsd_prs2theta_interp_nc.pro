...
ifiles=file_search(dirw+'f_1975-2010_2deg_refc1sd_wa4_tsmlt.002.cam.h5.*.sav',count=nfile)
;
; loop over files
;
...
;
    result=file_search(dirw+'f_1975-2010_2deg_refc1sd_wa4_tsmlt.002.cam.h5.'+sdate+'.nc3')
...
;
ofile=dirw+'f_1975-2010_2deg_refc1sd_wa4_tsmlt.002.cam.h5.'+sdate+'.nc'
print,'writing ',ofile
