...
'geos5_20130301_attrex_10d_back_1hr.traj'$
]
...
;
    ...
    gphsave=xmsfsave
;
; SAVE trajectory locations in IDL SAVE format
;
    save,file=ifilet(nn)+'.sav',xsave,ysave,zsave,pvsave,psave,tmpsave,gphsave,agesave,mdates,etimes
print,'saved ',ifilet(nn)+'.sav'
