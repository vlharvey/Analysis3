;
; run on MacD88
; read CIPS level 2 version 4.2 data and plot albedo vs SZA each day
;
loadct,39
mcolor=!p.color
...
pth='/Volumes/Data/CIPS_data/Datfiles_Rejected/cips_sci_2_orbit_'	; run on macd2813
...
;
      spawn,'ls '+pth+'*'+syear+'-'+sday+'*v04.20_r05_cat_prelim.nc',fnamescat
      spawn,'ls '+pth+'*'+syear+'-'+sday+'*v04.20_r05_cld_prelim.nc',fnamescld
...
plot,sza,alb,psym=3,color=0,xtitle='SZA',ytitle='Version 4.10 CIPS Albedo (10!u-6!n str!u-1!n)',title=sdate,xrange=[40.,90.],yrange=[0.,100.]
endif
cloud=WHERE(ALB GT ALBLIM,ncloud)	; AND CLOUD_INDEX EQ 1,ncloud)
;           SZA LT SZALIM_HI AND SZA GT SZALIM_LO AND $nlayers gt 6.,NCLOUD)
if cloud(0) ne -1L then oplot,sza(cloud),alb(cloud),psym=3,color=0
;
; color by radius
;
index=where(rad ge 1. and rad le 10.)
if index(0) ne -1L then oplot,sza(index),alb(index),psym=3,color=mcolor*.1
index=where(rad gt 10. and rad le 20.)
if index(0) ne -1L then oplot,sza(index),alb(index),psym=3,color=mcolor*.2
index=where(rad gt 20. and rad le 30.)
if index(0) ne -1L then oplot,sza(index),alb(index),psym=3,color=mcolor*.3
index=where(rad gt 30. and rad le 40.)
if index(0) ne -1L then oplot,sza(index),alb(index),psym=3,color=mcolor*.4
index=where(rad gt 40. and rad le 50.)
if index(0) ne -1L then oplot,sza(index),alb(index),psym=3,color=mcolor*.5
index=where(rad gt 50. and rad le 60.)
if index(0) ne -1L then oplot,sza(index),alb(index),psym=3,color=mcolor*.6
index=where(rad gt 60. and rad le 70.)
if index(0) ne -1L then oplot,sza(index),alb(index),psym=3,color=mcolor*.7
index=where(rad gt 70. and rad le 80.)
if index(0) ne -1L then oplot,sza(index),alb(index),psym=3,color=mcolor*.8
index=where(rad gt 90.)
if index(0) ne -1L then oplot,sza(index),alb(index),psym=3,color=mcolor*.9
