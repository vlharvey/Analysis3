...
; Input data:  IDL>restore,'/Volumes/cloud/data/WACCM_data/Datfiles_SD/f_1975-2010_2deg_refc1sd_wa4_tsmlt.002.cam.h5.20120701.nc
; dimensions:
;
loadct,39
device,decompose=0
...
ifiles=file_search(dirw+'f_1975-2010_2deg_refc1sd_wa4_tsmlt.002.cam.h5.????????.nc',count=nfile)
;
; loop over files
;
FOR n=0l,nfile-1l DO BEGIN
    ...
    sdate=result(4)
    print,sdate
    result=file_search(dirw+'f_1975-2010_2deg_refc1sd_wa4_tsmlt.002.cam.h5.'+sdate+'.nc2')
...
;
ofile=dirw+'f_1975-2010_2deg_refc1sd_wa4_tsmlt.002.cam.h5.'+sdate+'.nc2'
print,'writing ',ofile
nocid = ncdf_create(ofile,/CLOBBER)
