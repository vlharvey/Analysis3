...
;
      if icount eq 0L then begin
         QRS_SO2ANAFPL_avg=fltarr(nr,nl,kday)
         QRS_SO2BNAFPL_avg=fltarr(nr,nl,kday)
      endif
;
; loop over years and retain all data
;
      print,'restored '+dum(0)
      QRS_SO2ANAFPL_avg(*,*,icount)=QRS_SO2ANAFPL
      QRS_SO2BNAFPL_avg(*,*,icount)=QRS_SO2BNAFPL
;
jumpday:
      icount=icount+1L
goto,jump
...
save,file=ofile,sdate_all,lat,lev,QRS_SO2ANAFPL_avg,QRS_SO2BNAFPL_avg
