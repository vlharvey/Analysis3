...
limit = [-60,0,-10,360]; Set plot limits based on the mean CIPS lat/lon

			Map_Set,0,0,0,/merc,/NoErase,position = [.1,.2,.9,.8],color=0,limit = limit,/CONTINENTS
...
if index(0) ne -1L then oplot,xc(index),yc(index),color=col2(0),psym=8,symsize=0.25
			...
			contour, datalocations,lon_cips,lat_cips,level=[.1],color = 250, /overplot,/noerase,/close,c_color = 0, c_thick = 8
                        ...
                        Map_Set,0,0,0,/merc,/NoErase,position = [.1,.2,.9,.8],color=0,limit = limit,/CONTINENTS
 		        MAP_GRID, /LABEL, LATLAB=floor(cips_lon_mean)+8., LONLAB=floor(cips_lat_mean)-3, LATDEL=5, LONDEL=45, charsize=2.5
;
...
; for 300 hPa
;
      contour,sp,alon2,alat,/overplot,levels=[30.],thick=5,color=.3*mcolor,c_labels=[1]
      contour,sp,alon2,alat,/overplot,levels=[40.],thick=5,color=.4*mcolor,c_labels=[1]
      contour,sp,alon2,alat,/overplot,levels=[50.],thick=5,color=.55*mcolor,c_labels=[1]
      contour,sp,alon2,alat,/overplot,levels=[60.],thick=5,color=.75*mcolor,c_labels=[1]
      contour,sp,alon2,alat,/overplot,levels=[70.],thick=5,color=.8*mcolor,c_labels=[1]
      contour,sp,alon2,alat,/overplot,levels=[80.],thick=5,color=.9*mcolor,c_labels=[1]
      contour,sp,alon2,alat,/overplot,levels=[90.],thick=5,color=.99*mcolor,c_labels=[1]
;
; for 1 hPa
;
;     contour,sp,alon2,alat,/overplot,levels=[30.+50.],thick=5,color=.3*mcolor,c_labels=[1]
;     contour,sp,alon2,alat,/overplot,levels=[40.+50.],thick=5,color=.4*mcolor,c_labels=[1]
;     contour,sp,alon2,alat,/overplot,levels=[50.+50.],thick=5,color=.55*mcolor,c_labels=[1]
;     contour,sp,alon2,alat,/overplot,levels=[60.+50.],thick=5,color=.75*mcolor,c_labels=[1]
;     contour,sp,alon2,alat,/overplot,levels=[70.+50.],thick=5,color=.8*mcolor,c_labels=[1]
;     contour,sp,alon2,alat,/overplot,levels=[80.+50.],thick=5,color=.9*mcolor,c_labels=[1]
;     contour,sp,alon2,alat,/overplot,levels=[90.+50.],thick=5,color=.99*mcolor,c_labels=[1]

loadct,0
      drawvectors,nc+1,nr,alon2,alat,u,v,10,1
save,file='merra2_windspeed_300hPa_20160716.sav',nc,nr,alon2,alat,u,v,sp
;
; vortex edge
;
...
loadct,0
				...
				!p.title = ' '
				if airsplot eq 0 then position = [.3,0.1, .7,.2]
