...
c --- gridded GEOS-5 analyses of pv,p,u,v,qdf,q,msf,mark,z,tmp into
...
c include file for netCDF functions
      ...
      parameter(nc=96,nr=72,nth=30,klv=60)
...
c 3d constant height arrays
     ...
     +                 vmsfz,vmarkz,vvpz,vsfz,vtz,vzz
      ...
      character hdr*34,prefix*38,ifile*93

      data mon /'jan_','feb_','mar_','apr_','may_','jun_',
     +          'jul_','aug_','sep_','oct_','nov_','dec_'/
c theta levels
      data thlev /5000.,4800.,4600.,4400.,4200.,4000.,3800.,3600.,
     +            3400.,3200.,3000.,2800.,2600.,2400.,2200.,2000.,
     +            1800.,1600.,1400.,1200.,1000., 900., 800., 700.,
     +             600., 550., 500., 450., 400., 350./
      data hdr /'/aura7/harvey/GEOS5_data/Datfiles/'/
      data prefix /'DAS.ops.asm.tavg3d_dyn_v.GEOS501.MetO.'/
      data ex /.false./
...
40    write (6,'(A,$)') ' Enter ending date (mm dd yyyy) '
      ...
      if (lstyr.lt.2007) stop 'Year out of range '
      if (ledyr.lt.2007) stop 'Year out of range '
...
c --- Test for end condition and close windows.
      ...
      write(ifile,'(a34,a38,i4,i2.2,i2.2,a13)')
     +      hdr,prefix,iyr,imn,idy,'_1200.V01.nc3'
...
120   format('v5d.geos5.',i4,'.',i3.3,'.',i6)
