...
; Input data:  IDL>restore,'/Volumes/Data/WACCM/Datfiles_Chandran/wa3548_2x_refb1.1.cam2.h3.19971020.sav
; LAT             DOUBLE    = Array[96]
; LEV             DOUBLE    = Array[66]
...
ifiles=file_search(dirw+'wa3548_2x_refb1.1.cam2.h3.*.sav',count=nfile)
;
; loop over files
;
...
;
    result=file_search(dirw+'wa3548_2x_refb1.1.cam2.h3.'+sdate+'.nc3')
...
;
ofile=dirw+'wa3548_2x_refb1.1.cam2.h3.'+sdate+'.nc'
print,'writing ',ofile
