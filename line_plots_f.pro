...
;array(*,35:69) is descending.
   ...
   plot,[0,0],[0,0],/nodata,title='Frequency, 85!uo!n'+shem
   li=where(round(lat) eq 85)
   oplot,ddd,100.*array(*,li(0)),thick=5,color=11
   oplot,ddd,100.*array(*,li(1)),thick=5,color=3
   xyouts,0.4,0.38,'Asc',color=11,/normal,charsize=1.2
   xyouts,0.4,0.35,'Dsc',color=3,/normal,charsize=1.2

   plot,[0,0],[0,0],/nodata,title='Frequency, 70!uo!n'+shem
